    ...
    <div className={cn(
      ...
      <div className="absolute top-4 right-4 z-20">
        <div className="flex items-center gap-0.5 rounded-lg border border-border/70 bg-white/95 dark:bg-[#121212] px-1 py-1">
          ...
          {/* Open in v0 */}
          {mounted && sourceCodeKey && (
            <a
              href={`https://v0.dev/chat/api/open?url=${encodeURIComponent(`${window.location.origin}/r/${sourceCodeKey}.json`)}`}
              target="_blank"
              rel="noreferrer"
              className={cn(iconButtonClass, "w-auto px-2 font-mono text-[10px] font-bold tracking-tight text-foreground/70 hover:text-foreground")}
              aria-label="Open in v0"
            >
              <svg className="w-3 h-3 mr-1.5" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M21.9023 20C21.9023 24.3217 21.0366 27.6015 19.4673 29.6264C18.1561 31.3181 16.4026 32.2222 14.3908 32.2222C12.3392 32.2222 10.5691 31.2829 9.27891 29.5492C7.75704 27.5039 6.87939 24.1672 6.87939 20C6.87939 15.6782 7.74507 12.4411 9.31427 10.4162C10.6256 8.68181 12.3956 7.77771 14.3908 7.77771C16.4426 7.77771 18.2291 8.71704 19.5026 10.4508C21.0245 12.4961 21.9023 15.8328 21.9023 20ZM14.3908 10.6111C13.208 10.6111 12.167 11.2323 11.4552 12.2592C10.3541 13.8488 9.77123 16.4839 9.77123 20C9.77123 23.5161 10.3541 26.1511 11.4552 27.7408C12.167 28.7676 13.208 29.3888 14.3908 29.3888C15.5736 29.3888 16.6312 28.7676 17.3263 27.7408C18.4275 26.1511 19.0104 23.5161 19.0104 20C19.0104 16.4839 18.4275 13.8488 17.3263 12.2592C16.6312 11.2323 15.5736 10.6111 14.3908 10.6111Z" fill="currentColor"/>
                <path d="M26.242 16.4444C27.9351 16.4444 28.6045 17.0655 28.8475 18.1561L31.6243 29.5492C31.83 30.6406 31.0664 31.6666 29.9575 31.6666C29.0729 31.6666 28.3243 31.0632 28.1062 30.2039L27.6748 28.6666H23.5574C23.0163 28.6666 22.5694 28.2435 22.5694 27.6666C22.5694 27.0898 23.0163 26.6666 23.5574 26.6666H27.1102L26.3129 23.535H21.2152V18.1561C21.4647 17.0655 22.1281 16.4444 23.8211 16.4444H26.242ZM25.8617 18.4444H24.1685C23.9515 18.4444 23.87 18.4907 23.8158 18.6756L22.8465 21.535H26.7905L26.2135 18.6672C26.1633 18.503 26.0786 18.4444 25.8617 18.4444Z" fill="currentColor"/>
              </svg>
              v0
            </a>
          )}
