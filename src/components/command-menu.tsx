            ...
            <>
              ...
              >
                ...
                >
                  ...
                  {/* this in Command.List but the last elment is not visualy apper will */}
                  {/* [mask-image:linear-gradient(to_bottom,transparent,black_2rem,black_calc(100%-2rem),transparent)] */}
                  <Command.List className="max-h-[400px] overflow-y-auto overscroll-contain p-2 scrollbar-none [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
